...
var mifuncionprueba = function mifuncionprueba(a,b){
  return a+b;
}
...
var topProductsInit = function topProductsInit() {
  ...
  if ($echartBarTopProducts) {
    var data = [
      ['produccion', 'Insumos', 'Medicamentos', 'CPT'],
      ['Enero', 1363959.47, 1777057.72, 1863016.32],
      ['Febrero', 1777057.72, 730000.40, 528070.17],
      ['Marzo', 1746061.28, 1863016.32, 1863016.32],
      ['Abril', 1863016.32, 530006, 1863016.32],
      ['Mayo', 1442475.19, 1863015.80, 1777057.72],
      ['Junio', 613838.13, 1442475.19, 1746061.28],
      ['Julio', 52807.17, 1442475.19, 52807.17]
    ];
    var userOptions = utils.getData($echartBarTopProducts, 'options');
    var chart = window.echarts.init($echartBarTopProducts);
    var getDefaultOptions = function getDefaultOptions() {
      return {
        color: [utils.getColors().primary, utils.getGrays()['300'], '#2ecc71'],
        dataset: {
          source: data
        },
        tooltip: {
...
var topProductsInitprueba = function topProductsInitprueba(data) {
  var ECHART_BAR_TOP_PRODUCTS = '.echart-bar-top-products';
  var $echartBarTopProducts = document.querySelector(ECHART_BAR_TOP_PRODUCTS);
  if ($echartBarTopProducts) {
    var userOptions = utils.getData($echartBarTopProducts, 'options');
        ...
        yAxis: {
          ...
          axisLabel: {
            ...
            formatter: function (value) {
              // Formatear el valor a "3k", "5k", etc.
              if (value >= 1000) {
...
var topProductsInitBrutoNeto = function topProductsInitprueba(data) {
  var ECHART_BAR_TOP_PRODUCTS = '.echart-bar-top-products';
  var $echartBarTopProducts = document.querySelector(ECHART_BAR_TOP_PRODUCTS);
  if ($echartBarTopProducts) {
    var userOptions = utils.getData($echartBarTopProducts, 'options');
